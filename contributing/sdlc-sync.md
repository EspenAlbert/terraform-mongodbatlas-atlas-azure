...
The cluster module defines shared tooling in [`.github/sdlc.src.yaml`](https://github.com/EspenAlbert/terraform-mongodbatlas-atlas-azure/blob/v0.0.2/.github/sdlc.src.yaml). The `path-sync` tool copies files one-way from cluster to destination modules.
