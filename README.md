...
- You can use this and replace the `var.project_id` with `mongodbatlas_project.this.project_id` in the [main.tf](https://github.com/EspenAlbert/terraform-mongodbatlas-atlas-azure/blob/v0.0.1/main.tf) file.
...
Feature | Name
--- | ---
Backup Export | [Azure Blob Storage Export](https://github.com/EspenAlbert/terraform-mongodbatlas-atlas-azure/blob/v0.0.1/examples/backup_export)
Encryption at Rest | [Azure Key Vault Integration (User-Provided)](https://github.com/EspenAlbert/terraform-mongodbatlas-atlas-azure/blob/v0.0.1/examples/encryption)
Encryption at Rest | [Azure Key Vault (Module-Managed with Private Networking)](https://github.com/EspenAlbert/terraform-mongodbatlas-atlas-azure/blob/v0.0.1/examples/encryption_create_key_vault_private_networking)
Private Link | [Azure Private Endpoint (Module-Managed)](https://github.com/EspenAlbert/terraform-mongodbatlas-atlas-azure/blob/v0.0.1/examples/privatelink)
Private Link | [Azure Private Endpoint (Bring Your Own Endpoint)](https://github.com/EspenAlbert/terraform-mongodbatlas-atlas-azure/blob/v0.0.1/examples/privatelink_byoe)
Private Link | [Multi-Region Private Endpoints](https://github.com/EspenAlbert/terraform-mongodbatlas-atlas-azure/blob/v0.0.1/examples/privatelink_multi_region)
