...
* variable/atlas_to_azure_region: Exposes region mapping as an overridable variable instead of hardcoded locals, allowing users to restrict or customize allowed regions ([#31](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster/pull/31))
